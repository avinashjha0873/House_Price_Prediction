...
raw_data_path = r"D:\Python\House_Price_Prediction\data\raw\kc_house_data.csv"
...
def drop_rows(df):
    ...
    Housing_data['Plot_Living'] = Housing_data['Sqft_Plot'] - Housing_data['Sqft_Living']
...
if __name__ ==    "__main__":
    data = get_dataset(raw_data_path)
